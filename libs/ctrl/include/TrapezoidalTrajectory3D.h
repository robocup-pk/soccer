#ifndef TRAPEZOIDAL_TRAJECTORY_3D_H
#define TRAPEZOIDAL_TRAJECTORY_3D_H
...
class TrapezoidalTrajectory3D : public Trajectory3D {
 public:
  TrapezoidalTrajectory3D(Eigen::Vector3d pose_start, Eigen::Vector3d pose_end, double t_start_s,
                          double t_end_s);
...
#endif  // TRAPEZOIDAL_TRAJECTORY_3D_H