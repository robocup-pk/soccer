...
PlanarCurveSegment PlanarCurveFactory::createSegmentFromTimeInterval(
    ...
    // This matches the Sumatra approach where segments can represent constant acceleration phases
    ...
    // Create SECOND_ORDER segment (matches Sumatra's approach for BangBang trajectories)
