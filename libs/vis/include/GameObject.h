...
class GameObject {
 public:
  ...
  GameObject(std::string name, glm::vec2 pos, glm::vec2 size,
             ...
             glm::vec2 acceleration = glm::vec2(0.0f, 0.0f), float mass_kg = 1, Texture2D sprite = Texture2D(false),
             glm::vec3 color = glm::vec3(1.0f));
  GameObject(std::string name, glm::vec2 pos, double radius,
             glm::vec2 velocity = glm::vec2(0.0f, 0.0f),
             glm::vec2 acceleration = glm::vec2(0.0f, 0.0f), float mass_kg = 10, Texture2D sprite = Texture2D(false),
             glm::vec3 color = glm::vec3(1.0f));
