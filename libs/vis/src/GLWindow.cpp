...
void vis::GLWindow::InitGameObjects() {
  ...
  // ResourceManager::LoadTexture("../resources/textures/ball.png", false, "ball");
  ...
  // Ball
  // game_objects.push_back(
  //     GameObject("ball", vis::GLConfig::init`_ball_pos, vis::GLConfig::ball_radius_cm,
